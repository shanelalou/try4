...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			$('#grid').flexigrid({
				url: 'http://gordoncollegeccs.edu.ph/ccswebsite/faculty/class/students/functions/list.php?class=<?php echo $_GET['class']?>&ay=<?php echo $_GET['ay']?>&sem=<?php echo $_GET['sem']?>',
				dataType: 'json',
				buttons: [
